...
class _SalaryCalculationScreenState extends State<SalaryCalculationScreen> {
  ...
  double _otherBenefitsOverride = -1; // -1 = خودکار
  ...
  Future<void> _saveAndShowPayslip({bool deductLoanInstallments = true}) async {
    ...
    try {
      ...
      // اگر کسر اقساط فعال است، اقساط را ثبت کن
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('فیش حقوق با موفقیت ذخیره شد'),
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: _employees.isEmpty
          ? const Center(child: Text('ابتدا کارمندان را در منوی «مدیریت کارمندان» ثبت کنید'))
          : Row(
              children: [
                      ...
                      ..._employeeLoans.map((l) => Padding(
                            ...
                            child: Row(
                              children: [
                                ...
                                CurrencyText(l.installmentAmount,
                                    style: const TextStyle(fontSize: 13)),
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            decoration: BoxDecoration(
              gradient: const LinearGradient(
                colors: [AppTheme.successColor, Color(0xFF1B5E20)],
              ),
              borderRadius: BorderRadius.circular(12),
            ),
            child: Column(
              children: [
                ...
                Row(
                  children: [
                    ...
                    const Text('ریال', style: TextStyle(color: Colors.white70, fontSize: 14)),
                  ],
                ),
              ],
            ),
  ...
  Widget _resultRow(String label, double value, {bool white = false, bool bold = false}) {
    ...
    final color = white ? Colors.white : AppTheme.textPrimary;
    return Padding(
