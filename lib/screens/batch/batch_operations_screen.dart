  ...
  List<List<Object?>> _financialRows() => [
    ...
    for (final record in _selectedRecords)
      [
        ...
        record.usePartTimeWage ? 'بله' : 'خیر',
        _formatDays(record.partTimeWorkHours, persian: false),
        record.mandatoryMonthlyHours.round(),
        _formatDays(record.leaveDays, persian: false),
        _formatDays(record.sickLeaveDays, persian: false),
        record.baseSalary.round(),
        record.housing.round(),
        record.food.round(),
        record.marriage.round(),
        record.childAllowance.round(),
        record.shiftWork.round(),
        record.shiftWorkRate,
        record.seniority.round(),
        record.otherBenefits.round(),
        record.jobRelatedBenefits.round(),
        record.employeeRelatedBenefits.round(),
        record.welfareBenefits.round(),
        _formatDays(record.overtimeHours, persian: false),
        record.overtimeBaseDaily.round(),
        record.overtimeAmount.round(),
        _formatDays(record.nightWorkHours, persian: false),
        record.nightWorkAmount.round(),
        _formatDays(record.fridayWorkHours, persian: false),
        record.fridayWorkAmount.round(),
        _formatDays(record.holidayWorkHours, persian: false),
        record.holidayWorkAmount.round(),
        _formatDays(record.missionDays, persian: false),
        record.missionAmount.round(),
        _formatDays(record.hourlyBenefitHours, persian: false),
        record.hourlyBenefitsAmount.round(),
        record.totalEarnings.round(),
        record.totalDeductions.round(),
        record.taxBase.round(),
        record.twoSevenExemption.round(),
        record.taxReliefRate,
        record.taxReliefAmount.round(),
        record.tax.round(),
        record.insuranceBase.round(),
        record.insurance.round(),
        record.loanInstallment.round(),
        record.advance.round(),
        record.supplementaryInsurance.round(),
        _formatDays(record.absenceDays, persian: false),
        _formatDays(record.absenceHours, persian: false),
        record.absenceDeduction.round(),
        _formatDays(record.leaveAllowanceDays, persian: false),
        _formatDays(record.excessLeaveDays, persian: false),
        record.leaveDeduction.round(),
        record.otherDeductions.round(),
