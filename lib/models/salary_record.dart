...
class SalaryRecord {
  ...
  final int workDays; // کارکرد خالص
  ...
  factory SalaryRecord.fromMap(Map<String, dynamic> map) => SalaryRecord(
        ...
        leaveDays: map['leave_days'] as int,
        workDays: map['work_days'] as int,
        ...
        hourlyBenefitsAmount: (map['hourly_benefits_amount'] as num?)?.toDouble() ?? 0,
